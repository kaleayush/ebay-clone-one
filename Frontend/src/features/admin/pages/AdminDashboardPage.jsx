  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard icon={DollarSign} label="Total Revenue" value={formatCurrency(stats.totalRevenue || 0)} color="bg-green-500" />
        <StatCard icon={ShoppingBag} label="Total Orders" value={(stats.totalOrders || 0).toLocaleString()} color="bg-primary" />
        <StatCard icon={Package} label="Active Listings" value={(stats.activeListings || 0).toLocaleString()} color="bg-yellow-500" />
